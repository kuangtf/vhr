package com.vhr.ktf.framework.aspectj;

import com.alibaba.fastjson.JSON;
import com.vhr.ktf.common.annotation.Log;
import com.vhr.ktf.common.core.domain.model.LoginUser;
import com.vhr.ktf.common.enums.BusinessStatus;
import com.vhr.ktf.common.enums.HttpMethod;
...
public class LogAspect {
    ...
    private static final Logger log = LoggerFactory.getLogger(com.vhr.ktf.framework.aspectj.LogAspect.class);

    /**
     * 处理完请求后执行
     * jsonResult 要返回的变量的名称
     *
     * @param joinPoint 切点
     */
    ...
    /**
     * 获取注解中对方法的描述信息，用于 Controller层注解
     * 
     * @param log 日志
     * @param operLog 操作日志
     * @throws Exception 异常
