...
import com.vhr.ktf.web.core.util.QiNiuUtil;
...
public class SysProfileController extends BaseController {
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws IOException, InvalidExtensionException {
        if (!file.isEmpty()) {
            LoginUser loginUser = getLoginUser();
            // String avatar = FileUploadUtils.upload(vhr.ktfConfig.getAvatarPath(), file);
            String avatar = QiNiuUtil.fileUpload(file);
